...
import 'package:air_drop/widgets_common/home_buttons.dart';
                ...
                child: Column(
                  children: [
                    ...
                    VxSwiper.builder(
                        ...
                        height:150,
                        itemCount: slidersList.length, itemBuilder:(context,index){
                      return Image.asset(secondSlidersList[index],fit: BoxFit.fill,).box.rounded.clip(Clip.antiAlias).margin(const EdgeInsets.symmetric(horizontal:8 )).make();
                    }),
                    20.heightBox,
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(image: AssetImage(featuredImg),fit: BoxFit.cover),
                        // color: redColor,
                      ),
                      child:
                      Column(
                    ...
                    Align(alignment: Alignment.centerLeft, child: "All Products".text.color(darkFontGrey).size(18).fontFamily(semibold).make()),
                    ...
                    GridView.builder(
                      ...
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Image.asset(imgP5,width: 200,fit: BoxFit.cover,height: 200,),
                          Spacer(),
                          "Laptop 4GB/64GB".text.fontFamily(semibold).color(darkFontGrey).make(),
                          10.heightBox,
                          "\$600".text.color(redColor).fontFamily(bold).size(16).make()
